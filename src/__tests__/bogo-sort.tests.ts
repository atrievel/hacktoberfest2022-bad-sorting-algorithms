...
describe("Bogo Sort Test Suite", () => {
  ...
  it("sorts numbers in asc order by default", () => {
    // Arrange
    const uut = new BogoSort(randomOrderNumbers);
  ...
  it("sorts numbers in desc order", () => {
    // Arrange
    const uut = new BogoSort(randomOrderNumbers, true);
  ...
  it("sorts strings in asc order by default", () => {
    // Arrange
    const uut = new BogoSort(randomOrderStrings);
  ...
  it("sorts strings in desc order", () => {
    // Arrange
    const uut = new BogoSort(randomOrderStrings, true);
